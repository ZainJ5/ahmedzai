                  ...
                  <table className="w-full text-sm border-collapse font-['Inter',sans-serif]">
                    ...
                    <tbody>
                      {[
                        ...
                        { label: 'Engine Displacement', value: product.engine?.displacement ? `${product.engine.displacement} cc` : 'N/A' },
                        { label: 'Number of Cylinders', value: product.engine?.cylinders || 'N/A' },
                        { label: 'Horsepower', value: product.engine?.horsepower ? `${product.engine.horsepower} hp` : 'N/A' },
                        { label: 'Engine Configuration', value: product.engine?.configuration || 'N/A' },
                        { label: 'City Mileage', value: product.mileage?.city ? `${product.mileage.city} ${product.mileage.unit || 'km/l'}` : 'N/A' },
