...
export default function BrandLogoGrid() {
  ...
  const getItemsPerPage = () => {
    // We'll handle the actual display through CSS grid
    return 10; // Keep 10 as base, but display will change responsively
  };
        ...
        >
          ...
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-6 mb-8"
              ref={carouselRef}
            >
